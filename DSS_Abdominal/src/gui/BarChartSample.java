...
public class BarChartSample extends Application implements Initializable {
    ...
    public void start(Stage stage) {
        ...
        series1.setName("IBS"); 
        series1.getData().add(new Data("",MainWindow.ibsPorcentage));
        
        Series series2 = new Series();
        series2.setName("Chrons"); 
        series2.getData().add(new Data("", MainWindow.chronPorcentage));
        
        Series series3 = new Series();
        series3.setName("Ulcera"); 
        series3.getData().add(new Data("", MainWindow.ulcerativeColitisPorcentage));
         
        Series series4 = new Series();
        series4.setName("Diverticulosis"); 
        series4.getData().add(new Data("", MainWindow.diverticulosisPorcentage));
        
        Series series5 = new Series();
        series5.setName("Hernia"); 
        series5.getData().add(new Data("", MainWindow.herniaPorcentage));
        
        Series series6 = new Series();
        series6.setName("Appendicitis"); 
        series6.getData().add(new Data("", MainWindow.appendicitisPorcentage));
        
        
        Series series7 = new Series();
        series7.setName("Enterocolitis"); 
        series7.getData().add(new Data("", MainWindow.enterocolitisPorcentage ));
        
        Series series8 = new Series();
        series8.setName("Celiac");
        series8.getData().add(new Data("", MainWindow.celiacPorcentage));
        
        Series series9 = new Series();
        series9.setName("Rectal cancer");
        series9.getData().add(new Data("", MainWindow.colorectalCancerPorcentage));
