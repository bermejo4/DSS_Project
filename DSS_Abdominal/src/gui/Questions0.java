...
public class Questions0 implements Initializable, QuestionPanel {
    ...
    public void checkRadialButtons(ActionEvent event) throws Exception {
        ...
        Toggle genetic_toggle = genetic.getSelectedToggle();
        Toggle ulcers_toggle = ulcers.getSelectedToggle();

        if (smokes_selected == null || gender_toggle == null || age_toggle == null || genetic_toggle == null || ulcers_toggle == null) {
    ...
    public void getQuestionValues() {
        ...
        System.out.println("Patient new values: " +
                ...
                "\n\t Smokes: " + patient.isTobacco() +
                "\n\t Genetic: " + patient.isGenetic() +
                "\n\t Ulcers: " + patient.isUlcers());
    }
